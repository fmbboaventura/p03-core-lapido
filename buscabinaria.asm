...
LOOP:
		...
		load  r1,r0 ; carrega em r1 o valor do endereço da posição
		beq r15,r1, EXIT ; colocar a condição pra verificar se o valor foi encontrado			
		slt r6,r15,r1 ;se o valor de r15 for menor que o valor na posiçao do array armazena 1 em r6  
		beq r6,zero MENOR ; colocar condição para verificar se o valor do index é menor que o valor buscado
